...
public:
  ...
  //! Renvoie l'identifiant de l'articulation père de l'articulation numéro i
   ...
   void setPose(const chara::BVH& bvh, int frameNumber, const Transform& m);


   //! Positionne ce squelette entre la position frameNbSrc du BVH Src et la position frameNbDst du bvh Dst
   void setPoseInterpolation(const chara::BVH& bvhSrc, int frameNbSrc, const chara::BVH& bvhDst, int frameNbDst, float t, const Transform& m);
